...
namespace Data.Migrations
{
    ...
    [Migration("20250719144610_update node for support IpAddress")]
    partial class updatenodeforsupportIpAddress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Instance", b =>
                {
                    ...
                    b.Property<int>("AssignedInboundPort")
                        .HasColumnType("int");

                    b.Property<int>("AssignedServerPort")
                        .HasColumnType("int");

                    b.Property<int>("AssignedXrayPort")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NodeId", "AssignedInboundPort")
                        .IsUnique();

                    b.HasIndex("NodeId", "AssignedServerPort")
                        .IsUnique();

                    b.HasIndex("NodeId", "AssignedXrayPort")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.Node", b =>
                {
                    ...
                    b.Property<string>("PanelIpAddress")
                        .IsRequired()
                        .HasMaxLength(50)
